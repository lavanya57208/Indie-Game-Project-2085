        ...
        <div className="hud-panel p-6 mb-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-start gap-3">
              ...
              <p className="text-cyan-100/70"><span className="text-green-300 font-semibold">AI Chips</span> — Collect to weaken the Alien AI Control System. Reach 1000 to win.</p>
            </div>
            <div className="flex items-start gap-3">
        ...
        <div className="hud-panel p-6">
          ...
          <div className="space-y-2">
            <div className="flex items-start gap-3">
              ...
              <p className="text-cyan-100/70">Collect 1000 AI Chips and disable the Alien AI Control System.</p>
            </div>
            <div className="flex items-start gap-3">
